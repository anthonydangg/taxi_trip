...
<h3 align="center">Taxi Trip Estimator</h3>

  <p align="center">
    Deep learning models to predict taxi trip times in Portugal
    <br />
    <br />
    <br />
  </p>
...
View the various models in the `model` folder to see the different types of deep learning models and their respective performances on the dataset.
